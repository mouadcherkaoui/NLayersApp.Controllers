...
namespace NLayersApp.Controllers.Tests
{
    [TestClass]
    public class CommandController_With_EF_Handlers_Tests
    {
        ...
        public CommandController_With_EF_Handlers_Tests()
        {
            ...
            {
                new TestModel(){ Id = 1, Name="test1", Description="description1"},
                new TestModel(){ Id = 2, Name="test2", Description="description2"},
                new TestModel(){ Id = 3, Name="test3", Description="description3"}
            };
        }
